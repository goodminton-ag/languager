 ...
 */
class Goodminton_Languager_Block_Adminhtml_Categories_Container extends Mage_Adminhtml_Block_Widget_Form_Container
{
    public function __construct()
    {
        ...
        $this->_headerText = 'Languager categories attributes management';
    }
}